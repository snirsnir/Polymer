...
function nex1(){
	...
	document.getElementById("nextb2").style.visibility= "visible";
	document.getElementById("nextb2").style.display = "block";
...
function ans(){
	var one = document.getElementById("checkboxOne").checked;
	var two = document.getElementById("checkboxTwo").checked;
	var three = document.getElementById("checkboxThree").checked;
	var four = document.getElementById("checkboxFour").checked;
	var five = document.getElementById("checkboxFive").checked;
	var six = document.getElementById("checkboxSix").checked;
	var seven = document.getElementById("checkboxSeven").checked;
	var eight = document.getElementById("checkboxEight").checked;	
	var firebaseRef = firebase.database().ref();
		firebaseRef.once('value', function(snapshot) {
	var a = snapshot.child('polymers').child('bi').val();
       if (two&&four&&seven&&!one&&!three&&!five&&!six&&!eight) {
...
numb = numb.join("");
    ...
    document.getElementById("wrong").style.visibility="visible";
			...
			counter +=1;
				...
				document.getElementById("correctans").innerHTML = "התשובה: " + a + "<br>" + "יש לבחור את האפשרויות";
				}
			}
...
var timeLeft = (3600+resInt[1]*60)+resInt[2]
	  ...
	  window.location.href = "mel2.html";
}

function nex2() {
		document.getElementById("nex3").style.visibility="visible";
	document.getElementById("nex3").style.display = "block";
		document.getElementById("nextb2").style.visibility= "hidden";
