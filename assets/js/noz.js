...
function nex1(){
	...
	document.getElementById("nex2").style.display = "block";
		 document.getElementById("textnatbag").style.visibility="visible";
		   document.getElementById("textnatbag").style.display = "block";
...
function ans(){
	...
	var a = snapshot.child('polymers').child('hit').val();
       if (a1 == a) {
